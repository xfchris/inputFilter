...
/** @class: InputFilter (PHP7.x with comments)
  * @project: PHP Input Filter
  * @date: 21-10-2019
  * @version: 2.0_php5
  * @author: Christian Valencia Cuero
  * @contributors: Gianpaolo Racca, Ghislain Picard, Marco Wandschneider, Chris Tobin and Andrew Eddie, Daniel Morris.
  * @email: valenciacuero2017@gmail.com
...
class InputFilter {
	...
	/** 
      ...
      * @autor valenciacuero2017@gmail.com
	  * @access protected
	  * @param String $source
	...
	protected function decode($source) {
		...
		// convert decimal
		// version 5.x $source = preg_replace('/&#(\d+);/me',"chr(\\1)", $source);				// decimal notation
        // version 7.x
